;(function($, window, document, undefined) {
	...
	var defaults = {
		...
		monthHuman: [["JAN", "Tháng 1"], ["FEB", "Tháng 2"], ["MAR", "Tháng 3"], ["APR", "Tháng 4"], ["MAY", "Tháng 5"], ["JUN", "Tháng 6"], ["JUL", "Tháng 7"], ["AUG", "Tháng 8"], ["SEP", "Tháng 9"], ["OCT", "Tháng 10"], ["NOV", "Tháng 11"], ["DEC", "Tháng 12"]],
		dayHuman: [["CN", "Chủ nhật"], ["T2", "Thứ 2"], ["T3", "Thứ 3"], ["T4", "Thứ 4"], ["T5", "Thứ 5"], ["T6", "Thứ 6"], ["T7", "Thứ 7"]],
		dayMachine: function(s) {
			var a = [];a["Sunday"] = 0;a["Monday"] = 1;a["Tuesday"] = 2;a["Wednesday"] = 3;a["Thursday"] = 4;a["Friday"] = 5;a["Saturday"] = 6;
			return a[s];
		},
		urlText: "Xem chi tiết",
		...
		for(var i=0;i<events.length;i++) {
			...
			if(!!ev.color) {
				...
				if(!!c) {
					...
					ev_p = !!c.text ? 'style="color:'+c.text+'"' : "";
